...
const navigation = [
  { name: 'Takvim', href: '/calendar', icon: Calendar, description: 'Proje takvimleri ve görevler' },
  { name: 'Projeler', href: '/projects', icon: FolderKanban, description: 'Proje yönetimi ve takibi' },
  { name: 'Takım', href: '/team', icon: Users, description: 'Ekip üyeleri ve roller' },
  { name: 'İş Gücü', href: '/workload', icon: BarChart3, description: 'İş yükü analizi' },
  { name: 'Raporlar', href: '/reports', icon: FileText, description: 'Detaylı raporlar ve analitik' },
  { name: 'Bildirimler', href: '/notifications', icon: Bell, description: 'Sistem bildirimleri' },
]
          ...
          <div className='flex items-center space-x-2 flex-shrink-0'>
            ...
            <button className={cn(
              ...
              <div className={cn(
                ...
                scrolled ? 'bg-gray-200 text-gray-500' : 'bg-white/20 text-white/70'
              )}>
                ⌘K
              </div>
            </button>
              ...
              {isUserMenuOpen && (
                <div className='absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50 animate-in slide-in-from-top-2 duration-200'>
                  <div className='px-4 py-3 border-b border-gray-100'>
                    <p className='text-sm font-medium text-gray-900'>Temsada Admin</p>
